...
import { ElementsOptions, ElementOptions, StripeCardComponent, StripeService, TokenResult } from 'ngx-stripe';
...
export class AddCardComponent implements OnInit {
  ...
  getToken() {
    ...
    if (name && address_line1 && address_city && address_state && address_country) {
      return this.stripeService.createToken(this.card.getCard(), {
          name,
          address_line1,
          address_city,
          address_state,
